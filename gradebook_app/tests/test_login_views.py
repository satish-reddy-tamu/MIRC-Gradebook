...
class TestProfileViews(TestCase):
    ...
    def test_login_profile_access_denied(self):
        ...
        login = self.client.login(username='testuser', password='12345')
        Profile.objects.create(email = "abc@gmail.com", type = "pl", first_name = "asd", last_name = "asd", department= "dep", phone = "23123" )
    ...
    def test_login_profile_student(self):
        self.user = User.objects.create_user(username='testuser', password='12345', email = 'abc@gmail.com')
        login = self.client.login(username='testuser', password='12345')
        Profile.objects.create(email = "abc@gmail.com", type = "student", first_name = "asd", last_name = "asd", department= "dep", phone = "23123" )
        response = self.client.get('/login', {'user' : self.user})
        self.assertEquals(response.status_code, 200)
    ...
    def test_login_profile_admin(self):
        ...
        login = self.client.login(username='testuser', password='12345')
        Profile.objects.create(email = "abc@tamu.edu", type = "admin", first_name = "asd", last_name = "asd", department= "dep", phone = "23123" )
        response = self.client.get('/login', {'user' : self.user})
        self.assertEquals(response.status_code, 200)
    ...
    def test_login_profile_professor(self):
        self.user = User.objects.create_user(username='testuser', password='12345', email = 'abc@gmail.com')
        login = self.client.login(username='testuser', password='12345')
        Profile.objects.create(email = "abc@gmail.com", type = "professor", first_name = "asd", last_name = "asd", department= "dep", phone = "23123" )
        response = self.client.get('/login', {'user' : self.user})
        self.assertEquals(response.status_code, 200)
